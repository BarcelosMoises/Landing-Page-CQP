...
export const CURSOS_PROFISSIONALIZANTES: Curso[] = [
  ...
  { id: 'pro-arquitetura',          nome: 'Arquitetura',                                categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/arquitetura.png',                                 modalidades: ['presencial', 'online'] },
  { id: 'pro-assist-adm',           nome: 'Assistente Administrativo',                  categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/assistente-adm.png',                             modalidades: ['presencial', 'online'] },
  ...
  { id: 'pro-atend-caixa',          nome: 'Atendente de Caixa',                         categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/atendente-de-caixa.png',                         modalidades: ['presencial'] },
  ...
  { id: 'pro-atend-cliente',        nome: 'Atendimento ao Cliente',                     categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/atendimento-ao-cliente.png',                     modalidades: ['presencial', 'online'] },
  ...
  { id: 'pro-design-grafico',       nome: 'Design Gráfico',                             categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/design-grafico.png',                             modalidades: ['presencial', 'online'] },
  { id: 'pro-e-commerce',           nome: 'E-commerce',                                 categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/e-commerce.png',                                 modalidades: ['presencial', 'online'] },
  { id: 'pro-empreendedorismo',     nome: 'Empreendedorismo',                           categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/empreendedorismo.png',                           modalidades: ['presencial', 'online'] },
  { id: 'pro-gestao-pessoas',       nome: 'Gestão de Pessoas',                          categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/gestao-de-pessoas.png',                          modalidades: ['presencial', 'online'] },
  { id: 'pro-hotelaria',            nome: 'Hotelaria e Turismo',                        categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/hotelaria-e-turismo.png',                        modalidades: ['presencial', 'online'] },
  { id: 'pro-informatica',          nome: 'Informática',                                categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/informatica.png',                                 modalidades: ['presencial', 'online'] },
  { id: 'pro-jovem-aprendiz',       nome: 'Jovem Aprendiz',                             categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/jovem-aprendiz.png',                             modalidades: ['presencial'] },
  { id: 'pro-lideranca',            nome: 'Liderança Empresarial',                      categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/liderança-empresarial.png',                      modalidades: ['presencial', 'online'] },
  { id: 'pro-logistica',            nome: 'Logística',                                  categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/logistica.png',                                  modalidades: ['presencial', 'online'] },
  { id: 'pro-marketing-digital',    nome: 'Marketing Digital',                          categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/marketing-digital.png',                          modalidades: ['presencial', 'online'] },
  ...
  { id: 'pro-programacao',          nome: 'Programação',                                categoria: 'profissionalizantes', imagem: '/images/cursos-profissionalizantes/programador.png',                                 modalidades: ['presencial', 'online'] },
];
...
export const CURSOS_GRADUACOES: Curso[] = [
  ...
  { id: 'grad-ciencias-aeronauticas',nome: 'Ciências Aeronáuticas',                    categoria: 'graduacoes', imagem: '/images/graduacoes/ciencias-aeronauticas.png',                modalidades: ['presencial'], extra: '4 anos' },
  ...
  { id: 'grad-coaching-mentoring',   nome: 'Coaching e Mentoring',                     categoria: 'graduacoes', imagem: '/images/graduacoes/coaching-e-mentoring.png',                 modalidades: ['presencial', 'online'], extra: '2 anos' },
  { id: 'grad-coding',               nome: 'Coding',                                   categoria: 'graduacoes', imagem: '/images/graduacoes/coding.png',                               modalidades: ['presencial', 'online'], extra: '2,5 anos' },
  ...
  { id: 'grad-ciencia-dados',        nome: 'Ciência de Dados',                         categoria: 'graduacoes', imagem: '/images/graduacoes/data-science.jpg',                         modalidades: ['presencial', 'online'], extra: '2,5 anos' },
  { id: 'grad-design-interiores',    nome: 'Design de Interiores',                     categoria: 'graduacoes', imagem: '/images/graduacoes/design-de-interiores.png',                 modalidades: ['presencial', 'online'], extra: '2,5 anos' },
  { id: 'grad-digital-security',     nome: 'Segurança Digital',                        categoria: 'graduacoes', imagem: '/images/graduacoes/digital-security.png',                     modalidades: ['presencial', 'online'], extra: '2,5 anos' },
  ...
  { id: 'grad-farmacia',             nome: 'Farmácia',                                 categoria: 'graduacoes', imagem: '/images/graduacoes/farmacia.png',                             modalidades: ['presencial'], extra: '5 anos' },
  { id: 'grad-filmmaker',            nome: 'Filmmaker',                                categoria: 'graduacoes', imagem: '/images/graduacoes/filmmaker.png',                            modalidades: ['presencial', 'online'], extra: '2,5 anos' },
  { id: 'grad-fisioterapia',         nome: 'Fisioterapia',                             categoria: 'graduacoes', imagem: '/images/graduacoes/fisioterapia.png',                         modalidades: ['presencial'], extra: '5 anos' },
  { id: 'grad-game-design',          nome: 'Game Design',                              categoria: 'graduacoes', imagem: '/images/graduacoes/game-design.png',                          modalidades: ['presencial', 'online'], extra: '2,5 anos' },
  { id: 'grad-geografia',            nome: 'Geografia',                                categoria: 'graduacoes', imagem: '/images/graduacoes/geografia.png',                            modalidades: ['presencial'], extra: '4 anos' },
  ...
  { id: 'grad-historia',             nome: 'História',                                 categoria: 'graduacoes', imagem: '/images/graduacoes/historia.png',                             modalidades: ['presencial'], extra: '4 anos' },
  { id: 'grad-ia',                   nome: 'Inteligência Artificial',                  categoria: 'graduacoes', imagem: '/images/graduacoes/ia.png',                                   modalidades: ['presencial', 'online'], extra: '2,5 anos' },
  { id: 'grad-iot',                  nome: 'Internet das Coisas (IoT)',                categoria: 'graduacoes', imagem: '/images/graduacoes/iot.png',                                  modalidades: ['presencial', 'online'], extra: '2,5 anos' },
  ...
  { id: 'grad-service-design',       nome: 'Service Design',                           categoria: 'graduacoes', imagem: '/images/graduacoes/service-design.png',                       modalidades: ['presencial', 'online'], extra: '2,5 anos' },
  { id: 'grad-streaming',            nome: 'Streaming Pessoal',                        categoria: 'graduacoes', imagem: '/images/graduacoes/streaming-pessoal.png',                    modalidades: ['presencial', 'online'], extra: '2 anos' },
  { id: 'grad-teologia',             nome: 'Teologia',                                 categoria: 'graduacoes', imagem: '/images/graduacoes/teologia.png',                             modalidades: ['presencial'], extra: '4 anos' },
];
