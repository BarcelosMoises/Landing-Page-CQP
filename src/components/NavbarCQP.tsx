...
export default function NavbarCQP({
  ...
  // Detect when the hero exits the viewport to activate the solid navbar
  useEffect(() => {
  ...
  // Highlight active section via IntersectionObserver on each nav target
  useEffect(() => {
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .navbar {
          ...
          transition:
            ...
            backdrop-filter 350ms var(--ease-out-expo);
        }
        ...
        .navbar--solid {
          ...
          box-shadow: 0 1px 0 oklch(from #33B8B8 l c h / 0.10);
        }
        ...
        .navbar-mobile-link {
          ...
          text-decoration: none;
          border-bottom: 1px solid oklch(from #33B8B8 l c h / 0.10);
        ...
        .navbar-mobile-cta:focus-visible {
          background: var(--cqp-teal-dark);
        }
      ...
      {/* Skip to content */}
      <a href="#main-content" className="navbar-skip">
      ...
      >
        ...
        >
          {/* Logo mark — minimal SVG hexagonal shield */}
          <svg
            ...
            aria-hidden="true"
          >
            <rect width="36" height="36" rx="8" fill="#33B8B8" fillOpacity="0.15" />
            <path
              d="M18 6L28 11.5V20.5C28 25.2 23.5 29.2 18 30C12.5 29.2 8 25.2 8 20.5V11.5L18 6Z"
              stroke="#33B8B8"
              strokeWidth="1.75"
